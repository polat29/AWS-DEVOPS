...
- Go the Cloudformation console and create a stack based on the template in the handson folder.
...
- show the content of web page. It is the same as ELB.
...
- You can keep the bucket with your domain for further use. 
